...
class iRelationsExtractor:
    ...
    def extract_relations(self, context: str, entities: List[str], doc_id:str, embeddings: bool = True, property_name = "properties", relation_name_key = "name", doc_name = 'doc_id'):
        """
        ...
        if "relationships" not in relationships.keys() or relationships == None:
            ...
            self.extract_relations(context=context, entities=entities, doc_id=doc_id, embeddings=embeddings, property_name=property_name, relation_name_key=relation_name_key, doc_name=doc_name)
        if not entities:
            return []
    ...
    def extract_relations_for_isolated_entities(self, context: str, local_non_isolated_entities:List[str], doc_id:int, isolated_entities:List[str], embeddings: bool = True, property_name = "properties", entity_name_key = "name", doc_name='doc_id'):
        """
